    ...
    try:
        ...
        #for i in range(count - 1, len(links)):    
            ...
            if "acecwply" in url:
             ...
             url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..GZ-3j7MCX2M34U5OvkW33vMTI0VIpL2EveHK7_Yc0Ls'}).json()['url']
