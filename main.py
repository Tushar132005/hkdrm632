...
bot = Client("bot",
             bot_token= "7309596863:AAH9ni-iGptkq8Gv1_VIDySq04sk5kiyhVA", 
    ...
    try:
        ...
        #for i in range(count - 1, len(links)):    
            ...
            if "acecwply" in url:
             ...
             url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..akh6n7xcpgFZW7Ei-7ZQ6Dx9m9r33xMl3a01BbqCyMg'}).json()['url']
